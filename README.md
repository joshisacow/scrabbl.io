...
```
cd existing_repo
git remote add origin https://coursework.cs.duke.edu/jc869/scrabbl.io.git
git branch -M main
...
- [ ] [Set up project integrations](https://coursework.cs.duke.edu/jc869/scrabbl.io/-/settings/integrations)
